...
rialacha.pl : rialacha.in rialacha.meta.sed
	rm -f rialacha.pl
	(echo "#!$(PERL)"; echo '# Users should modify rialacha.in, not this file'; echo 'while(<>){';  cat rialacha.in | sed -f rialacha.meta.sed; echo 'print;'; echo '}'; echo 'exit;') > rialacha.pl
	chmod 555 rialacha.pl

aonchiall.pl : aonchiall.in aonchiall.meta.sed
	rm -f aonchiall.pl
