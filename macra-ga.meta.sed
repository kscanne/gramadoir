...
s/NOTDO/[^<][^<][^<]+/g
s/AWITHGSM/(<A[^>]*>)*<A pl="n" gnt="y" gnd="m".>(<A[^>]*>)*/g
s/AWITHGSF/(<A[^>]*>)*<A pl="n" gnt="y" gnd="f".>(<A[^>]*>)*/g
s/ANYWITHGSF/(<[^>]*>)*<A pl="n" gnt="y" gnd="f".>(<[^>]*>)*/g
s/AWITHPL/(<A[^>]*>)*<A pl="y" gnt="n".>/g
s/AWITHCOMMON/<A pl="n" gnt="n".>(<A[^>]*>)*/g
...
s/NMADJ/<N pl="n" gnt="n" gnd="m".><A pl="n" gnt="n".>(<[A-Z][^>]*>)*/g
