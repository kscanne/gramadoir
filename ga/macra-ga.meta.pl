...
s/PASTNORFORMLEN/(?:(?:[Dd]úi?r|[Rr]ai?bh|[Ff]uair|[Ff]hac|[Dd]heach|[Dd]hearna)[^<]*|[Ff]uarthas)/g;
s/PASTNORFORM/(?:n[Dd]úi?r|[Rr]ai?bh|bh[Ff]uai?r|bh[Ff]ac|n[Dd]each|n[Dd]earna)[^<]*/g;
...
s/UNBOUNDADJ/(?:[^<]+th?[ae]|céad|cibé|cosúil|deich|dhá|eile|[Gg]ach|seacht|[Ss]eo|[Ss]in|trí|úd|uile|[^<]+ [^<]+)/g;
...
s/LENITEDNGMPERSON/(?:(?:[CcDdFfGgMmPpSsTt][Hh]|[Bb]h[^fF])[^<]+(?:[óú]ra|eora|éara|aí)|chailín|dhuine|fhir|pháiste|bhuachalla)/g;
s/LENITEDNGFPERSON/(?:bhaintrí|chlainne|mhná|ghirsí)/g;
s/NGMPERSON/(?:[^<]+(?:[óú]ra|eora|éara|aí)|cailín|duine|fir|páiste|buachalla)/g;
s/NGFPERSON/(?:baintrí|clainne|mná|girsí)/g;
...
# don't allow spaces; "ribí róibéis" is tagged as plural noun!
s/SLENDERFINALCONSONANT/[^< ]*[eéií][^aeiouáéíóú<]+/g;
s/BROADFINALCONSONANT/[^< ]*[aáoóuú][^aeiouáéíóú<]+/g;
# only used in one rule, for leniting "déag"; no spaces!
